...
public interface EasyLanguageListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link EasyLanguageParser#g}.
	 * @param ctx the parse tree
	 */
	void enterG(EasyLanguageParser.GContext ctx);
	/**
	 * Exit a parse tree produced by {@link EasyLanguageParser#g}.
	 * @param ctx the parse tree
	 */
	void exitG(EasyLanguageParser.GContext ctx);
}